...
public class MainActivity extends AppCompatActivity {
  ...
  /**
   * This method was written during "Reactive Live Coding" presentation
   * shown on GDG DevFest 2015 in Warsaw, Poland. It's an exemplary usage of RxJava and RxAndroid.
   * It returns subscription, which should load limited number of guitars of given type to the
   * ListView. In case of error, it should display SnackBar with the error message generated by an
   * Exception.
   *
   * @param guitarType enum representing type of the guitar
   * @param guitarLimit limit of the guitars represented with integer value
